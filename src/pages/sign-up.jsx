...
export default function BosagSignUpPage() {
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem('bosagUser', JSON.stringify(formData));
          ...
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="John"
                  className="w-full px-4 py-3 border text-gray-400 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                />
              </div>
              <div>
            ...
            <div className="flex items-start">
              ...
              <label className="ml-2 text-sm text-gray-700">
                ...
                <a href="#" className="text-indigo-900 hover:text-indigo-700 font-medium underline">Terms of Service</a>{' '}
                and our{' '}
                <a href="#" className="text-indigo-900 hover:text-indigo-700 font-medium underline">Privacy Policy</a>
              </label>
            </div>
