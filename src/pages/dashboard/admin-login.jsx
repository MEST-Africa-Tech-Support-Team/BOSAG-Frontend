...
export default function BosagAdminLogin() {
      ...
      <div className="hidden lg:flex lg:w-[45%] bg-[#191970] text-white items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="text-center z-10 max-w-md">
          ...
          <div className="flex items-center justify-center gap-2 mb-8">
            ...
            <p className="text-xl tracking-wider">Adminstrator</p>
            <div className="h-0.5 w-16 bg-orange-500"></div>
          </div>
          <p className="text-lg leading-relaxed text-gray-200">
            Join our admin team and gain full access to powerful tools that keep the platform running smoothly.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-gray-900 mb-2">Log In as an Administrator</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="text-center mt-6">
              <p className="text-gray-600">
                ...
                <a href="/admin-signup" className="text-[#191970] hover:text-indigo-700 font-semibold">
                  Sign up
                </a>
              </p>
            </div>
